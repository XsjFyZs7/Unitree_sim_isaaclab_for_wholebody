...
# [新增] 导入 Matterport 配置
# 如果提示找不到模块，请确保您的环境启用了 omni.isaac.matterport 扩展
try:
    ...
    print("[WARNING] Could not import MatterportImporterCfg. Make sure omni.isaac.matterport extension is available.")
